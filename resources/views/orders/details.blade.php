            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-8">
                            <span class="badge {{ $order->status === 'paid' ? 'bg-success' : 'bg-danger' }} text-white">{{ ucfirst($order->status) }}</span>
                    ...
                    <div class="media mb-4">
                        <img src="{{ asset('images.jfif') }}" class="mr-3 rounded" alt="Product Image">
